...
public class DepositRequest implements Sample, WithLogger {
    ...
    public DepositRequest(String amount, String transactionTime, String accountNumber, String customerNumber) {
        this.amount = amount;
